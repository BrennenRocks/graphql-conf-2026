...
export type RoomHeader_RoomFragment = { __typename: 'Room', id: string, name: string, description: string, lightProfile: string } & { ' $fragmentName'?: 'RoomHeader_RoomFragment' };
...
export type RoomDetailRouteQueryQuery = { __typename: 'Query', room?: (
    { __typename: 'Room', id: string }
    & { ' $fragmentRefs'?: { 'RoomHeader_RoomFragment': RoomHeader_RoomFragment;'RoomPlantCountBadge_RoomFragment': RoomPlantCountBadge_RoomFragment } }
  ) | null };
