...
export type RoomHeader_RoomFragment = { __typename: 'Room', id: string, name: string, description: string } & { ' $fragmentName'?: 'RoomHeader_RoomFragment' };

export type RoomLightProfile_RoomFragment = { __typename: 'Room', lightProfile: string } & { ' $fragmentName'?: 'RoomLightProfile_RoomFragment' };

export type RoomListItem_RoomFragment = { __typename: 'Room', id: string, name: string, description: string } & { ' $fragmentName'?: 'RoomListItem_RoomFragment' };
...
export type RoomsPlannerLayoutQueryQuery = { __typename: 'Query', roomsConnection: { __typename: 'RoomConnection', edges: Array<{ __typename: 'RoomEdge', cursor: string, node: (
        ...
        & { ' $fragmentRefs'?: { 'RoomListItem_RoomFragment': RoomListItem_RoomFragment;'RoomPlantCountBadge_RoomFragment': RoomPlantCountBadge_RoomFragment } }
...
export type RoomDetailRouteQueryQuery = { __typename: 'Query', room?: (
    { __typename: 'Room', id: string }
    & { ' $fragmentRefs'?: { 'RoomHeader_RoomFragment': RoomHeader_RoomFragment;'RoomLightProfile_RoomFragment': RoomLightProfile_RoomFragment;'RoomPlantCountBadge_RoomFragment': RoomPlantCountBadge_RoomFragment } }
  ) | null };
